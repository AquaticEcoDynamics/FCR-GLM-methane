...
&aed_sed_const2d
   ...
   !Fsed_ch4 = 15, 15, 15, 232.6331575 Cayelan
   Fsed_ch4 = 3, 7, 8, 15
   !Fsed_ch4_ebb = 1, 1, 1, 1
   Fsed_ch4_ebb = 3, 1, 5, 5
   ...
   !Fsed_pon = 0,0,0,0
   !Fsed_don = 0,-0.3927,-1.9662,-1.1316 !,-1.1424,-1.5563,-0.8734,-0.7713,-1.6755,-0.7713,-0.7713,-0.7713,-0.7713,-0.5085,-0.6984,-0.5085,-0.6984,-0.473,-0.8737,-0.473,-0.5783,-0.6504,-0.5783,-0.5783,-0.8227,-0.5783,-0.5496,-0.8227,-0.5496,-0.5578,-0.6098,-0.5578,-0.5499,-0.5578,-0.6098,-0.5578
   !Fsed_pop = 0,0,0,0
   !Fsed_dop = 0,-0.01106,-0.05558,-0.03192 !,-0.03948,-0.04886,-0.0301,-0.019,-0.0376,-0.019,-0.019,-0.019,-0.019,-0.0126,-0.0213,-0.0126,-0.0213,-0.0117,-0.0215,-0.0117,-0.0117,-0.0131,-0.0117,-0.0117,-0.0166,-0.0117,-0.0111,-0.0166,-0.0111,-0.0113,-0.0123,-0.0113,-0.0111,-0.0113,-0.0123,-0.0113
   Fsed_poc = 1, 1, 1, 1
   !Fsed_doc = 0,-3.9305,-19.586,-11.2672 !,-13.9132,-17.2053,-10.6414,-9.3786,-18.5332,-9.3786,-9.3786,-9.3786,-9.3786,-6.1719,-10.5224,-6.1719,-10.5224,-5.7603,-10.6253,-5.7603,-5.7603,-6.4701,-5.7603,-5.7603,-8.2012,-5.7603,-5.4656,-8.2012,-5.4656,-5.5531,-6.0823,-5.5531,-5.46,-5.5531,-6.0823,-5.5531
   !Fsed_dic = 0,0,0,0
/
!&aed_sed_const2d
!   n_zones = 3
...
&aed_carbon
   ...
   ebb_model = 0
   ch4_s_initial = 5
   poc_s_initial = 600000.0
   poc_s_unr = 450000.0
   Rch4ox_sed       = 0.01
   Kch4ox_sed       = 0.01
   vTch4ox_sed      = 1.05
   Rpoc_resp        = 0.0001 !anywhere between 0.1 or less
   theta_poc_resp   = 1.1
   Kpocox_sed       = 10
   ch4_s_diff_coef  = 0.000000005
   beta             = 0.5 ! 1mop
   z_dbl            = 0.1
   Phi              = 0.3
   sed_z            = 0.01
...
&aed_methane
   ...
   ch4_schmidt_model = 5
   Fsed_ch4_variable = 'SDF_Fsed_ch4'
   ch4_oxid_target_variable = 'CAR_dic'
   ch4_oxic_prod = 0
   ...
   Rch4ox_sed       = %         Rch4oxS%
   Kch4ox_sed       = %         Kch4oxS%
   vTch4ox_sed      = %    theta_ch4oxS%
   Rpoc_resp        = %       rpoc_resp%
   theta_poc_resp   = %      theta_pocR%
   Kpocox_sed       = %      Kpocox_sed%
   ch4_s_diff_coef  = %       diff_coef%
   !beta             = 0.5 ! 1mop
   z_dbl            = %          z_dbl%
   gamma_max        = %       gamma_max%
   Phi              = %            Phi%
   ...
   !Fsed_poc_variable = 'SDF_Fsed_poc'
   LA               = 0.079
   !Ksed_beta       = 0.01038788804631400
   Kch4ox_diff      = %     Kch4ox_diff%
   ...
   ch4_bub_cLL = 1
   ch4_bub_kLL = 0
   ch4_bub_disdp = 7.831048638020698 !8
   ch4_bub_disf1 = 0 !0.02022618470163990 !0.02
   ch4_bub_disf2 = 0 !0.2967643630846519 !0.3
/
&aed_sediment
...
&aed_methane_bubbles
   nradius = 9
   ch4_diss_target_variable = 'CH4_ch4'
/
