...
for src in libplot libutil libaed-water libaed-benthic libaed-demo libaed-riparian libaed-light libaed-dev libaed-fv libaed2 libaed2-plus GLM gotm-git tuflowfv-svn ELCOM ; do
  if [ -d $src ] ; then
